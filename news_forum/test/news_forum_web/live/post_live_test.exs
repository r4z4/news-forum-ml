defmodule NewsForumWeb.PostLiveTest do
  use NewsForumWeb.ConnCase

  import Phoenix.LiveViewTest
  import NewsForum.ForumFixtures

  @create_attrs %{category: "some category", content: "some content", date: "2023-04-04T18:47:00", title: "some title"}
  @update_attrs %{category: "some updated category", content: "some updated content", date: "2023-04-05T18:47:00", title: "some updated title"}
