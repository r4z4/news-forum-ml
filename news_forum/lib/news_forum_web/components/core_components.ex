defmodule NewsForumWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(NewsForumWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(NewsForumWeb.Gettext, "errors", msg, opts)
    end
  end
